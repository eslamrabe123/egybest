...
import 'package:egybest/tv_module/presentation/screens/popular_tv_see_more_screen.dart';
import 'package:egybest/tv_module/presentation/screens/top_rated_see_more_tv_screen.dart';
...
import '../component/trending_tv_component.dart';
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const SeeMorePopularTV(),
                          ),
                        );
                      },
                      child: const Padding(
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const TopRatedTVSeeMoreScreen(),
                          ),
                        );
                      },
                      child: const Padding(
